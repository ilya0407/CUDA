...
int main(int argc, char** argv){
  ...
  in_file.open("train_image.txt", std::ifstream::in);
  ...
  in_file.open("train_label.txt", std::ifstream::in);
  for(int i = 0; i < train_data_size; i++)
  {
  ...
  in_file.open("validation_image.txt", std::ifstream::in);
  ...
  in_file.open("validation_label.txt", std::ifstream::in);
  for(int i = 0; i < validation_data_size; i++)
  {
  ...
  in_file.open("test_label.txt", std::ifstream::in);
  for(int i = 0; i < test_data_size; i++)
  {
